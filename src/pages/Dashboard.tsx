...
import { fetchDashboard } from '../services/radarApi';

export function Dashboard() {
  const { data: dashboardKpis, source, loading, error } = useAsyncData(fetchDashboard, kpis);
  ...
  return (
    <>
      ...
      <div className="dashboard-grid">
        ...
        <div className="card"><h3>Criticidade</h3><div className="donut"><strong>{alertas.length + impactos.length}</strong></div><p className="muted">Críticos, altos, médios e baixos no período.</p></div>
      </div>
